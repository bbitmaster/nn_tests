...
import cluster_select_func_cov as csf
from autoconvert import autoconvert
import sys
import time
from Shrink_Cov import Shrink_Cov

from cifar10_loader48 import load_cifar10_48
import os
...
print("Loading Data...")
(data_reduced,class_data,test_data_reduced,test_class_data) = load_cifar10_48(p['correct_target'],p['incorrect_target'])
reduce_to = 48
